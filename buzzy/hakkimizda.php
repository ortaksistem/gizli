...
<?php include("header.php"); ?>
   <div class="whitebg">
        <div class="container">
			...
			<div class="k-icerik">
				Buzyy.com 2004 yılında merhaba dediği internet sektörüne birçok önemli proje geliştirerek adım atmıştır. Dünyanın önde gelen yazılım şirketleri ile birçok alanda farklı algoritmalar geliştirerek web sektörüne önemli katkılar sağlamıştır. Amacımız Türk webmasterları için kolay kullanıma sahip bir analiz sistemi geliştirerek sizlere en hızlı ve kaliteli hizmeti sunmak olduğu gibi gelişmekte olan internet sektörümüze bir nevi katkı sağlamaktır.  
