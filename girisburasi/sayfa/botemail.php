...
if($islem == "bul"){
	...
	*/
	...
	$result = mysql_query("select email, botmesaji from "._MX."uye".$where."");
	
	$i = 0;
	
	while(list($email, $botmesaji) = mysql_fetch_row($result)){
	...
	?>
				<table class="listing form" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td class="first" width="172"><strong>Email Listesi<br /><br /><?=$i?> Adet</strong></td>
						<td class="last">
						<textarea style="width:100%;height:500px"><?=$data?></textarea>
						</td>
					</tr>
				</table>
	<?
...
<html>
<head>
	<title>Email Listesi Al | <? echo _AD; ?></title>
...
<script type="text/javascript">
	...
	function baslat(){
		...
		jQuery.ajax({
			...
			type: 'POST',
			url: 'index.php?sayfa=botemail&islem=bul',
...
<? include("menu/bot.php"); ?>
		...
		<form action="javascript:void(0)" method="post">
		  <div class="table">
				...
				<table class="listing form" cellpadding="0" cellspacing="0">
					<tr>
						<th class="full" colspan="2">Email Adresi Bul</th>
					</tr>
					<tr>
