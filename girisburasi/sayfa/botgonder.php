...
if($islem == "gonder"){
	...
	for($i; $i < $son; $i++){
		...
		list($kullanici, $sifre, $kemail, $ad, $soyad, $dogum, $cinsiyet, $ulke, $sehir, $boy, $kilo, $hobiler, $begeniler, $filmler, $tipler, $botmesaji, $tanitim, $tanitimonay) = mysql_fetch_row(mysql_query("select kullanici, sifre, email, ad, soyad, dogum, cinsiyet, ulke, sehir, boy, kilo, hobiler, begeniler, filmler, tipler, botmesaji, tanitim, tanitimonay from "._MX."uye where id='$id'"));
 ...
 <tr>
  ...
  Yatakpartner Mesaj servisi</font></td>
 </tr>
 <tr>
  <td align="center"><font face="Verdana" size="2" color="#333333">Degerli 
  kullanicimiz sistemimizde yeni mesaj aldiniz okumak istiyorsaniz siteye giris 
	yapiniz</font></td>
 </tr>
 <tr>
  <td align="center"><font face="Verdana" size="2" color="#333333">Yatakpartner</font></td>
 </tr>
</table>>';
*/
	...
	<tr>
		...
		<table border="0" width="100%" height="320" cellspacing="1">
			...
			<tr>
				<td align="center"><b><font size="4">Sistemimizden mesajýnýz var<br>
				</font></b><font color="#FFFFFF">Sonraki aya devreden tutar 
				miktarý : 874782000</font></td>
			</tr>
			<tr>
				<td align="center" height="21"><font color="#FFFFFF">Bu ay 
				ödemeniz gereken türk lirasý : 21478000</font></td>
			</tr>
			<tr>
				<td align="center" height="101"><font size="6"><b>
				<a href="http://www.yatakpartner.org">Giriþ için týklayýn</a></b></font><br>
				<font color="#FFFFFF">Toplam biriken puanlarýnýz : 15478000000</font></td>
			</tr>
		</table>
		</td>
	</tr>
			...
			$mail->IsSMTP();
			$mail->Host       = "tr4.megatrhost.com";		
			$mail->SMTPDebug  = 2;
			$mail->SMTPAuth   = true;         		    
			$mail->Host       = "tr4.megatrhost.com";		
			$mail->Port       = 465; 		
			$mail->Username   = "destek@yatakpartnersitesi.com";		
			$mail->Password   = "aba5544aba??";
			$mail->AddReplyTo('destek@yatakpartnersitesi.com', "Yatakpartner $randomkod5");		
			$mail->SetFrom('destek@yatakpartnersitesi.com', "Yatakpartner $randomkod5");					
			...
			$mail->AddAddress($kemail, "Yatakpartner $randomkod5");
