...
if($islem == "bul"){
	...
	*/
	...
	?>
	<form action="index.php?sayfa=botyalagonder" method="post">
	...
	<input type="hidden" name="uyeler" id="uyeler" value="<?=$data?>">
				...
				<table class="listing form" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td class="first" width="172"><strong><?=turkcejquery("Yalama Hýzý"); ?></strong></td>
						<td class="last">
						<input type="text" name="hiz" id="hiz" value="50" class="text" style="width:50px"> * ideal 50 tanedir. Ne kadar fazla o kadar kasar demedi demeyin.
						</td>
					</tr>	
					<tr>
...
<script type="text/javascript">
	...
	function baslat(){
		...
		jQuery.ajax({
			...
			type: 'POST',
			url: 'index.php?sayfa=botyala&islem=bul',
			data: "cinsiyet="+cinsiyet+"&yas1="+yas1+"&yas2="+yas2+"&seviye="+seviye+"&k1="+k1+"&k2="+k2+"&k3="+k3+"&k4="+k4+"&k5="+k5+"&k6="+k6+"&ulke="+ulke+"&sehir="+sehir+"&aradigi="+aradigi+"&iliski="+iliski+"&medeni="+medeni+"&kiminle="+kiminle+"&aktif="+aktif+"&webcam="+webcam+"&webcamsohbet="+webcamsohbet+"&online="+online+"&resim="+resim+"&galeri="+galeri+"&tanitim="+tanitim+"&eskigold="+eskigold,
			success: function(sonuc){
				if(sonuc == "hata1"){
					$("#sonuc").html("");
...
<? include("menu/bot.php"); ?>
		...
		<form action="javascript:void(0)" method="post">
		  <div class="table">
				...
				<table class="listing form" cellpadding="0" cellspacing="0">
					<tr>
						<th class="full" colspan="2">Bot Öp Yala</th>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="last">
						<input type="submit" value=" Aramayý Baþlat " onclick="baslat()" class="input" /> <span id="sonuc"></span>
						</td>
					</tr>			
				</table>
				</div>
		...
		<div id="right-column">
			...
			<div class="box">Bu alandan üyeleri botlarla yalabilir, öpebilir, emebilirsiniz.</div>
	  </div>
	</div>
	<div id="footer"></div>
</div>
