...
<html>
<head>
	<title>Bekleyen Duvar Yorumlarý | <? echo _AD; ?></title>
		...
		jQuery.ajax({
			...
			success: function(sonuc){	
				if(sonuc == "ok"){
					...
					alert("Yorum onaylanamadý tekrar deneyiniz");
				}
			}
		})
}
...
<? include("menu/uye.php"); ?>
		...
		<div id="right-column">
			...
			<div class="box">Duvar içeriklerinin bekleyen yorumlarý bu alanda bulunmaktadýr.</div>
	  </div>
	</div>
	<div id="footer"></div>
</div>
