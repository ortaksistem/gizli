...
<title>Large Arama <?=$uyeadi?>, <?=_BASLIK?></title>
							...
							<tr>
								...
								<table border="0" width="100%" id="table14" cellspacing="0" cellpadding="0">
									<tr>
										...
										<!-- icerik baslangic -->
										<form action="index.php?sayfa=arama_rumuzsonuc" method="post">
										<table border="0" width="100%" id="table173" cellspacing="0" cellpadding="0">
														...
														<tr>
																...
																<table border="0" width="100%" id="table215" cellspacing="0" cellpadding="0">
																	<tr>
																		...
																		<td>
																				<p class="form_txt"><b>sadece üye ismi ile ara</b></td>
																	</tr>
																</table>
																</td>
																<td width="15">&nbsp;</td>
																...
																<table border="0" width="100%" id="table216" cellspacing="0" cellpadding="0">
																	...
																	<tr>
																		...
																		<table border="0" width="100%" id="table217" cellspacing="0" cellpadding="0">
																			<tr>
																				<td width="200">
																				<p class="form_txt">sitemizde kayıtlı üyemizin rumuzunu yan tarafa hatırladığınız kadarını yazarak arama yapabilirsiniz</td>
																				<td width="25">&nbsp;</td>
																				<td>
																				<table border="0" id="table218" cellspacing="0" cellpadding="0">
																					<tr>
																						<td><input type="text" name="rumuz" id="rumuz" class="inputlar" size="30"></td>
																						<td width="12">&nbsp;</td>
																						<td><input type="image" src="img/buton_rumuzara.gif" width="73" height="22"></td>
																					</tr>
																				</table>
																				</form>
															...
															<tr>
																...
																<table border="0" width="100%" id="table270" cellspacing="0" cellpadding="0">
																	<tr>
																		...
																		<img border="0" src="img/1px.gif" width="1" height="1"></td>
																		<td>
																				<p class="form_txt"><font color="#FF5300"><b>aradığınız ilişki türü</b></font></td>
																	</tr>
																</table>
																</td>
																<td width="15">&nbsp;</td>
																	...
																	<tr>
																		...
																		<table border="0" width="100%" id="table450" cellspacing="0" cellpadding="0">
																			...
																			<?php
																				...
																				<table border="0" id="table451" cellspacing="0" cellpadding="0">
																					<tr>
																						<td><input type="checkbox" id="iliski[]" name="iliski[]" value="<?=$ad?>"></td>
																						<td>
															...
															<tr>
																...
																<table border="0" width="100%" id="table270" cellspacing="0" cellpadding="0">
																	<tr>
																		...
																		<img border="0" src="img/1px.gif" width="1" height="1"></td>
																		<td>
																				<p class="form_txt"><font color="#FF5300"><b>aradığınız medeni durum</b></font></td>
																	</tr>
																</table>
																</td>
																<td width="15">&nbsp;</td>
																	...
																	<tr>
																		...
																		<table border="0" width="100%" id="table450" cellspacing="0" cellpadding="0">
																			...
																			<?php
																				...
																				<table border="0" id="table451" cellspacing="0" cellpadding="0">
																					<tr>
																						<td><input type="checkbox" id="medeni[]" name="medeni[]" value="<?=$ad?>"></td>
																						<td>
																						<p class="form_txt"><?=$ad?></td>
																					</tr>
																				</table>
															...
															<tr>
																...
																<table border="0" width="100%" id="table270" cellspacing="0" cellpadding="0">
																	<tr>
																		...
																		<img border="0" src="img/1px.gif" width="1" height="1"></td>
																		<td>
																				<p class="form_txt"><font color="#FF5300"><b>aradığınız karakter türleri</b></font></td>
																	</tr>
																</table>
																</td>
																<td width="15">&nbsp;</td>
																	...
																	<tr>
																		...
																		<table border="0" width="100%" id="table450" cellspacing="0" cellpadding="0">
																			...
																			<?php
																				...
																				<table border="0" id="table451" cellspacing="0" cellpadding="0">
																					<tr>
																						<td><input type="checkbox" id="karakter[]" name="karakter[]" value="<?=$ad?>"></td>
																						<td>
																						<p class="form_txt"><?=$ad?></td>
																					</tr>
																				</table>
															...
															<tr>
																...
																<table border="0" width="100%" id="table270" cellspacing="0" cellpadding="0">
																	<tr>
																		...
																		<img border="0" src="img/1px.gif" width="1" height="1"></td>
																		<td>
																				<p class="form_txt"><font color="#FF5300"><b>kiminle yaşıyor</b></font></td>
																	</tr>
																</table>
																</td>
																<td width="15">&nbsp;</td>
																	...
																	<tr>
																		...
																		<table border="0" width="100%" id="table450" cellspacing="0" cellpadding="0">
																			...
																			<?php
																				...
																				<table border="0" id="table451" cellspacing="0" cellpadding="0">
																					<tr>
																						<td><input type="checkbox" id="kiminle[]" name="kiminle[]" value="<?=$ad?>"></td>
																						<td>
																						<p class="form_txt"><?=$ad?></td>
																					</tr>
																				</table>
																	...
																	<tr>
																		...
																		<table border="0" width="100%" id="table361" cellspacing="0" cellpadding="0">
																			<tr>
																				...
																				<option value="farketmez">Fartetmez</option>
																	<?
																	...
																	<tr>
																		...
																		<table border="0" width="100%" id="table338" cellspacing="0" cellpadding="0">
																			...
																			<tr>
																				...
																				<table border="0" id="table339" cellspacing="0" cellpadding="0">
																					<tr>
																						<td><input type="checkbox" name="uyelik" id="uyelik" value="1"></td>
																						<td>
																						<p class="form_txt">Ücretli Üye Olanlar</td>
																					</tr>
																				</table>
																				</td>
																				<td width="170" valign="top">
																				<table border="0" id="table339" cellspacing="0" cellpadding="0">
																					<tr>
																						<td><input type="checkbox" name="webcam" id="webcam" value="1"></td>
																						<td>
																						<p class="form_txt">Webcamı Olanlar</td>
																					</tr>
																				</table>
																				</td>
																			</tr>
											...
											<input type="hidden" name="aramatur" id="aramatur" value="large">
											</form>
										<!-- icerik bitis -->
										</td>
										<td width="8">&nbsp;</td>
