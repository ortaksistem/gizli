...
<title>Rumuz arama sonucu <?=$uyeadi?>, <?=_BASLIK?></title>
							...
							<tr>
								...
								<table border="0" width="100%" id="table14" cellspacing="0" cellpadding="0">
									<tr>
												...
												<table border="0" width="100%" id="table450" cellspacing="0" cellpadding="0">
													...
													<tr id="uyeler">
														...
														<tr>
															...
															$toplam = mysql_query("select count(id) from "._MX."uye where kullanici like '%$rumuz%'");
															...
															$result = mysql_query("select id, kullanici, cinsiyet, dogum, sehir, img, tanitim, seviye from "._MX."uye where  kullanici like '%$rumuz%' order by oncelik asc limit ".(($sayfa-1)*$limit).",".$limit."");
										...
										<form action="index.php?sayfa=arama_rumuzsonuc" method="post" name="aramaformu">
