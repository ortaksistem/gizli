...
<title>Çiçekleriniz <?=$uyeadi?>, <?=_BASLIK?></title>
...
<script type="text/javascript">
	...
	function temizle(){
		...
		var onayla = confirm("Tüm listeyi silmek istediğinizden emin misiniz?");
		...
		if(onayla){
			jQuery.ajax({
				...
				success: function(sonuc){		
					if(sonuc == "ok"){
						$("#opucukler").html('<td>&nbsp;</td><td width="510" align="center"><table border="0" width="100%" id="table566" cellspacing="0" cellpadding="0"><tr><td>&nbsp;</td><td width="510" align="center"><p class="tit_arkadas_mer"><b>çiçek listeniz boştur</b></td><td>&nbsp;</td></tr></table></td>');
					}
					else {
						$("#opucukler").html("<td colspan=3><p align=center><font color=red><b>Silme işlemi yapılamadı, lütfen daha sonra tekrar deneyin</b></font></p></td>");
	...
	function sayfa(hangi){
		window.location = 'index.php?sayfa=arkadas_cicekler&p='+hangi;
	}
</script>
</head>
											...
											<tr>
												...
												<table border="0" width="100%" id="table525" cellspacing="0" cellpadding="0">
													...
													<?php
														...
														$toplam = mysql_query("select count(id) from "._MX."uye_cicek where uye='$uyeid'");;
											...
											<tr>
												...
												<table border="0" width="100%" id="table525" cellspacing="0" cellpadding="0">
													...
													<?
														...
														$result = mysql_query("select gonderen, gonderenad, gonderencinsiyet, gonderensehir, kayit from "._MX."uye_cicek where uye='$uyeid' order by id desc limit ".(($p-1)*$limit).",".$limit."");
														
														while(list($gonderen, $gonderenad, $gonderencinsiyet, $gonderensehir, $kayit) = mysql_fetch_row($result)){
														
														list($dogum, $ulke, $img) = mysql_fetch_row(mysql_query("select dogum, ulke, img from "._MX."uye where id='$gonderen'"));
														
													
														
														if($img == "img_uye/avatar/null.jpg") $resim = "yok";
														else $resim = "var";
															...
															<tr>
																...
																<table border="0" width="100%" id="table567" cellspacing="0" cellpadding="0">
																	<tr>
																		...
																		<td width="6">&nbsp;</td>
																		<td width="15">
																		<img border="0" src="img/iko_resim<?=$resim?>.gif" width="15" height="15"></td>
																		<td width="7">&nbsp;</td>
											...
											<tr>
												...
												<table border="0" style="border-collapse: collapse" width="100%" cellpadding="0">
													<tr>
														...
														<td align="right">
														<a href="javascript:temizle()"><img border="0" src="img/btn_x_listeyi_bosalt.gif" width="80" height="18"></a></td>
