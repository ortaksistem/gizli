...
<title>Online Arkadaşlarım <?=$uyeadi?>, <?=_BASLIK?></title>
...
<script type="text/javascript">
	...
	function sayfa(hangi){
		window.location = 'index.php?sayfa=arkadas_onlinearkadaslarim&p='+hangi;
	}
</script>
</head>
										...
										<table border="0" width="100%" id="table201" cellspacing="0" cellpadding="0">
											...
											<tr>
												...
												<?
													...
													$result = mysql_query("select id, uye, arkadas, uyead, arkadasad, durum from "._MX."uye_arkadas where uye='$uyeid' or arkadas='$uyeid' order by id desc, durum asc limit ".(($p-1)*$limit).",".$limit."");
											...
											<?
													...
													$online = mysql_query("select count(uye) from "._MX."online where uye='$arkadas'");
											...
											<tr>
												...
												<p>&nbsp;</p>
												<font color=black size=2"><b>Eğer listeniz boş ise hiç online arkadaşınız bulunmamaktadır</b></font></td>
											</tr>
													<tr>
														<td>&nbsp;</td>
														<td width="510" align="center">
