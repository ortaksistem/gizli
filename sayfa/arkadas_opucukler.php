...
<title>Öpücükleriniz <?=$uyeadi?>, <?=_BASLIK?></title>
...
<script type="text/javascript">
	...
	function temizle(){
		...
		if(onayla){
			jQuery.ajax({
				type : 'POST',
				url : 'inc/arkadas.php',
				data : "islem=opucukler",
				success: function(sonuc){		
					if(sonuc == "ok"){
						$("#opucukler").html('<td>&nbsp;</td><td width="510" align="center"><table border="0" width="100%" id="table566" cellspacing="0" cellpadding="0"><tr><td>&nbsp;</td><td width="510" align="center"><p class="tit_arkadas_mer"><b>öpücük listeniz boştur</b></td><td>&nbsp;</td></tr></table></td>');
					}
					else {
	...
	function sayfa(hangi){
		window.location = 'index.php?sayfa=arkadas_opucukler&p='+hangi;
	}
</script>
</head>
											...
											<tr>
												...
												<table border="0" width="100%" id="table525" cellspacing="0" cellpadding="0">
													...
													<?
														...
														$result = mysql_query("select gonderen, gonderenad, gonderencinsiyet, gonderensehir, kayit from "._MX."uye_opucuk where uye='$uyeid' order by id desc limit ".(($p-1)*$limit).",".$limit."");
