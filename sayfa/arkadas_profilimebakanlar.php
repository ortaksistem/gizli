...
<title>Profilime Bakanlar <?=$uyeadi?></title>
...
<script type="text/javascript">
	...
	function temizle(){
		...
		var onayla = confirm("Tüm listeyi silmek istediğinizden emin misiniz? (Aylık profil izlenme hitiniz silinmez)");
		...
		if(onayla){
			jQuery.ajax({
				...
				success: function(sonuc){		
					if(sonuc == "ok"){
						$("#opucukler").html('<td>&nbsp;</td><td width="510" align="center"><table border="0" width="100%" id="table566" cellspacing="0" cellpadding="0"><tr><td>&nbsp;</td><td width="510" align="center"><p class="tit_arkadas_mer"><b>bakanlar listeniz boştur</b></td><td>&nbsp;</td></tr></table></td>');
					}
					else {
	...
	function sayfa(hangi){
		window.location = 'index.php?sayfa=arkadas_profilimebakanlar&p='+hangi;
	}
</script>
</head>
											...
											<tr>
												...
												<table border="0" width="100%" id="table525" cellspacing="0" cellpadding="0">
													...
													<tr>
														...
														<b>bakanlar listeniz boştur</b></td>
														<td>&nbsp;</td>
													</tr>
													<tr>
														<td>&nbsp;</td>
													...
													<?
														...
														$toplamsayfa = ceil($say/$limit);
														
														for($i = $carp; $i < $top; $i++){
														
														list($bakan, $bakanad, $tarih) = explode(";", $explode[$i]);
															
														
														if($bakan){
														
														list($dogum, $cinsiyet, $ulke, $sehir, $img) = mysql_fetch_row(mysql_query("select dogum, cinsiyet, ulke, sehir, img from "._MX."uye where id='$bakan'"));
															...
															<tr>
																...
																<table border="0" width="100%" id="table567" cellspacing="0" cellpadding="0">
																	<tr>
																		...
																		<p class="nickname">
																		<a class="form_txt2" href="javascript:void(0)" onclick="pencere('index.php?sayfa=profil&id=<?=$bakan?>', '745', '700', 'profilpopup<?=$bakan?>', 2, 1, 1);">
																		<font color=red><?=$bakanad?></font></a></td>
																		<td width="7">&nbsp;</td>
																		<td width="50">
																		<p class="yas">
																		Yaş <?=$yas?></td>
