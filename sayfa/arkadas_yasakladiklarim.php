...
<title>Yasakladımlarım <?=$uyeadi?>, <?=_BASLIK?></title>
...
<script type="text/javascript">
		...
		if(onayla){
			jQuery.ajax({
				...
				success: function(sonuc){		
					if(sonuc == "ok"){
						$("#opucukler").html("<td colspan=3><p align=center><font color=green><b>Tüm listeniz başarıyla temizlenmiştir</b></font></p></td>");
					}
					else {
	...
	function sil(id){
			...
			jQuery.ajax({
				type : 'POST',
				url : 'inc/arkadas.php',
				data : "islem=yasaklisil&id="+id,
				success: function(sonuc){		
					if(sonuc == "ok"){
						$("#yasakli"+id).hide("slow");
					}
					else {
						alert("Yasaklı Silinemedi Lütfen Sonra Tekrar Deneyiniz");
					}
				}
			})
	...
	function sayfa(hangi){
		window.location = 'index.php?sayfa=arkadas_yasakladiklarim&p='+hangi;
	}
</script>
</head>
											...
											<tr>
												...
												<table border="0" width="100%" id="table525" cellspacing="0" cellpadding="0">
													...
													<tr>
														...
														<b>yasaklı listeniz boştur</b></td>
														<td>&nbsp;</td>
													</tr>
													<tr>
														<td>&nbsp;</td>
													...
													?>
															<tr id="yasakli<?=$id?>">
																...
																<table border="0" width="100%" id="table567" cellspacing="0" cellpadding="0">
																	<tr>
																		<td width="14">
																		<a href="javascript:sil(<?=$id?>)" title="Sil"><img border="0" src="img/cross.png" /></a></td>
																		<td width="6">&nbsp;</td>
																		<td width="15">
