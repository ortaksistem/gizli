...
<style>
	...
	.tanitimhata {padding:2px 4px;margin:0px 0px 5px 0px;border:solid 1px #FBD3C6;background:#FDE4E1;color:#CB4721;font-family:Arial, Helvetica, sans-serif;font-size:12px;font-weight:bold;text-align:center;}
</style>
								...
								<table border="0" width="100%" id="table14" cellspacing="0" cellpadding="0">
									<tr>
										...
										<div class="tanitimhata">
											Profil tanıtım yazınız <b>Editor</b> tarafından red edilmiştir.
										</div>
										<?php
											}
										?>										
...
?>
<div class="asksurusu">
	<div class="nedir"><a href="#">A�k S�r��� Nedir?</a></div>
