...
<title>K.G.L Almak İstiyorum <?=$uyeadi?></title>
														...
														<td width="510" align="center">
																<table border="0" style="border-collapse: collapse" width="100%" cellpadding="0">
																	...
																	<tr>
																		...
																		kısaltılmış 
																		halidir.<br><br>
																		K.G.L li resim, siz üyelerimize ek güvenirlilik vermekle unutmayınız sistemimize her üye olan bayan yada çiftler gerçek olmayabilir bunu ayırt etmenin en kolay yolu K.G.L üyeliğidir
																		gerek 
																		site 
																		içinde 
																		veya 
																		...
																		çekip 
																		siteye 
																		eklediklerinde<br><br>*** Sistemimizden sınırsız Large üyelik alacaklar,<br>
																		*** Şuan üyelikleri olanlarda 
																		ek 
																		üyelik 
																		uzatması 
																		kazanarak 
																	...
																	$result = mysql_query("select kayit from "._MX."gks where uye='$uyeid' and durum='2'");
		
																	list($kayit) = mysql_fetch_row($result);
																	...
																	<tr>
																		...
																		echo '<p class="c"><b>'.$kayit.' tarihinde başvurunuz alınmıştır. Yöneticilerimiz tarafından incelendikten sonra size haber verilecektir</b></p>';
																		
																		}
																		else {
																		?>
																		<a href="index.php?sayfa=gks&islem=basvuru" title="Başvuruda Bulunun"><p class="c">
																		<b>K.G.L BAŞVURUSUNDA BULUNUN...</b></p></a>
																		<?php
																		}
																		?>
																	...
																	<tr>
																		...
																		<td>
																		<p class="c">
																		<a href="index.php?sayfa=profil_resim&tur=gks" title="Başvuruda Bulunun"><p class="c">
																		<b>K.G.L RESİMLERİNİ BURAYA  TIKLAYARAK YÜKLEYİN</b></p></a></td>
																		<td width="15">&nbsp;</td>
																	</tr>
																	<tr>
																		<td width="15">&nbsp;</td>
													...
													<tr>
														...
														<table border="0" id="table452" cellspacing="0" cellpadding="0">
															<tr>
																...
																<img border="0" src="img/9.jpg" width="100" height="100"></td>
																<td width="25">&nbsp;</td>
																<td valign="top" width="100">
																<img border="0" src="img/7.jpg" width="100" height="100"></td>
																<td width="25">&nbsp;</td>
																<td width="100">
																<img border="0" src="img/4.jpg" width="100" height="100"></td>
																<td width="25">&nbsp;</td>
																<td valign="top" width="100">
																<img border="0" src="img/11.jpg" width="100" height="100"></td>
															</tr>
															</table>
														</td>
														<td>&nbsp;</td>
