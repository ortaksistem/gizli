...
<script type="text/javascript">
	...
	function sayfa(sayfa){
		...
		window.location = 'index.php?sayfa=gks_uyeler&p='+sayfa;
												...
												<table border="0" width="100%" id="table450" cellspacing="0" cellpadding="0">
													...
													<tr id="uyeler">
														...
														<?php
															...
															$result = mysql_query("select id, kullanici, cinsiyet, dogum, sehir, img, tanitim, seviye from "._MX."uye where kgl='1' and durum='1' order by cinsiyet asc limit ".(($sayfa-1)*$limit).",".$limit."");
