...
if($cinsiyet != 1 and $cinsiyet != 2){
	...
	?>
		<script>
			alert("KGL videolarını sadece bayan ve çift üyelerimiz yükleyebilir");
...
<title>K.G.L Video Yükle <?=$uyeadi?></title>
...
<script type="text/javascript" src="video/jquery.flash.js"></script>
<script type="text/javascript" src="video/jquery.jqUploader.js"></script>
<style>
	body {
...
<script type="text/javascript">
   ...
   $(document).ready(function(){
                $('#dosyali').jqUploader({
                    ...
                    ,background:'f8f8f8'
                    ,barColor:'ff0000'
                    ,allowedExt:'*.avi; *.mp4; *.flv; *.mpg; *.mpeg; *.wmv; *.3gp'
                    ,allowedExtDescr: 'Ne istersin?'
                    ,validFileMessage: 'Dosya secildi'
                    ,endMessage: 'Dosya başarıyla yüklendi.'
                    ,hideSubmit: false
                });
   });	
   
   function basarili(dosya){
		
				jQuery.ajax({
					type : 'POST',
					url : 'inc/video.php',
					data : "islem=ekle&dosya="+dosya,
					success: function(sonuc){		
						if(sonuc == "hata"){
							$("#yuklediv").html("<p><font color='red'><b>Video yüklemesi sırasında problem meydana geldi, Lütfen sayfayı yenileyerek tekrar deneyin</b></fon></p>");
							alert("Video işlenmesi sırasında hata oluştu, Lütfen sayfayı yenileyip tekrar yükleyiniz");
						}
					}
				})
...
<table border="0" width="100%" id="table1" cellspacing="0" cellpadding="0" height="100%">
	<tr>
		...
		<table border="0" width="100%" id="table2" cellspacing="0" cellpadding="0">
			...
			<div id="yuklediv">
            <form enctype="multipart/form-data" action="../video/flash_upload.php" method="POST" class="dosyaform">
                <ul>
                        <li id="dosyali">
                            <label for="example1_field">Lütfen bir dosya seçiniz ( .mp4, .3gp, .flv, .mpg, .wmv, .avi): </label>
													...
													<tr>
														...
														<table border="0" width="100%" id="table451" cellspacing="0" cellpadding="0">
															...
															<tr>
																<td background="img/msg_kutusu_bg.gif" style="background-repeat:repeat-y;">
																	<ul>
																		<li class="style1"><strong>Bu alana açıklama gelicek</strong></li>
																	</ul>
