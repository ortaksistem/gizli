...
<title>K.G.L Videolar <?=$uyeadi?></title>
...
<script type="text/javascript">
	...
	function sayfa(sayfamiz){
		
		window.location = 'index.php?sayfa=gks_videolar&p='+sayfamiz
												...
												<table border="0" width="100%" id="table525" cellspacing="0" cellpadding="0">
													...
													<tr id="uyeler">
														...
														<?php
															...
															list($toplam) = mysql_fetch_row(mysql_query("select count(id) from "._MX."video where durum='1'"));
															
															$toplamsayfa = ceil($toplam/$limit);
															
															$result = mysql_query("select id, uye, hit, puan, durum from "._MX."video where durum='1' order by id desc limit ".(($sayfa-1)*$limit).",".$limit."");
															
															
															$i = 1;
															
															while(list($id, $kullanici, $hit, $oy, $durum) = mysql_fetch_row($result)){
															
															
															list($kullaniciad, $img, $dogum, $seviye) = mysql_fetch_row(mysql_query("select kullanici, img, dogum, seviye from "._MX."uye where id='$kullanici'"));
																...
																<table border="0" id="table453" cellspacing="0" cellpadding="0">
																	<tr>
																		...
																		<table border="0" width="100%" id="table457" cellspacing="0" cellpadding="0">
																			...
																			<tr>
																				<td height="70" align="center"><a href="index.php?sayfa=video&id=<?=$id?>"><img border="0" src="<?=$img?>" width="70" height="70"></a></td>
																			</tr>
																			<tr>
																				<td height="28" align="center">
																	...
																	<tr>
																		...
																		<p class="nickname">
																		<a class="form_txt2" href="javascript:void(0)" onclick="pencere('index.php?sayfa=profil&id=<?=$kullanici?>', '745', '700', 'profilpopup<?=$kullanici?>', 2, 1, 1);">
																		<font color="<?=$seviyerenk?>"><?=$kullaniciad?></font></a></td>
																	</tr>
																	<tr>
																		<td width="100" align="center" height="20">
																		<p class="yas"><?=$yas?> 
