...
<title>Üyelik Yükseltiniz <?=$uyeadi?>, <?=_BASLIK?></title>
								...
								<table border="0" width="100%" id="table14" cellspacing="0" cellpadding="0">
									<tr>
										...
										<table border="0" width="100%" id="table303" cellspacing="0" cellpadding="0">
												...
												<table border="0" style="border-collapse: collapse" width="100%" cellpadding="0">
													<tr>
														...
														<table border="0" style="border-collapse: collapse" width="100%" cellpadding="0">
															...
															<tr>
																<td>
																				<p class="tit_profil_mer"><span style="font-size: 16pt"><font color="#686868">Bu alanı kullanabilmek için
																				</font><font color="#1984D3"><b>Medium</b></font><font color="#686868"> yada 
																				</font><font color="#E52223"><b>Large</b></font><font color="#686868"> üye
																				olmanız gerekmektedir.</font></span></td>
															</tr>
															<tr>
																<td height="40">&nbsp;</td>
															</tr>
															<tr>
																<td>
																<a href="index.php?sayfa=uyelik_yukselt"><img border="0" src="img/btn_uyehop.gif" width="230" height="35"></a></td>
															</tr>
														</table>
														</td>
														<td width="20">&nbsp;</td>
											...
											<tr>
												<td background="img/alert_kapa.jpg" height="41">
												&nbsp;</td>
											</tr>
											<tr>
												<td>&nbsp;</td>
