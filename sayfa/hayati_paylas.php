...
<title>Hayatı Paylaş <?=$uyeadi?>, <?=_BASLIK?></title>
								...
								<table border="0" width="100%" id="table14" cellspacing="0" cellpadding="0">
									<tr>
										...
										<table border="0" width="100%" id="table303" cellspacing="0" cellpadding="0">
											...
											<tr>
												<td background="img/hytipaylas_bg.jpg" height="325">
												<table border="0" style="border-collapse: collapse" cellpadding="0">
													<tr>
														<td width="20">&nbsp;</td>
														<td width="190">
														<p class="tit_arama_mer">
														<font style="font-size: 17pt; font-weight: 700" color="#DD0EA0">Hayat Paylaştıkça Güzel!</font></td>
													</tr>
													<tr>
													...
													<tr>
														...
														<td width="190">
														<p class="form_txt">
														Fantazileri paylaşmanın 
														nihai hedefi, ilişkiyi 
														daha iyiye götürmektir.</td>
													</tr>
													<tr>
														<td width="20">&nbsp;</td>
														<td width="190">&nbsp;</td>
													...
													<tr>
														<td width="20">&nbsp;</td>
														<td width="190">
														<a href="index.php?sayfa=hayati_paylas_oku"><img border="0" src="img/btn_okumakistiyorum.gif" width="190" height="35"></a></td>
													</tr>
													<tr>
														<td width="20" height="4"></td>
														<td width="190" height="4"></td>
													</tr>
													<tr>
														<td width="20">&nbsp;</td>
														<td width="190">
											...
											<tr>
												<td background="img/hytipaylas_altkapa.jpg" height="41">
												&nbsp;</td>
											</tr>
											<tr>
												<td>&nbsp;</td>
