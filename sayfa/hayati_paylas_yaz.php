...
<title>Hayatı Paylaş Yaz <?=$uyeadi?>, <?=_BASLIK?></title>
...
<script type="text/javascript">
	...
	function gonder(){
		...
		var konu = document.getElementById("baslik").value;
		var mesaj = document.getElementById("mesaj").value;
		
		if(konu == ""){
			$("#gondersonuc").html("<font color=red><b>Konuyu yazın</b></font>");
		}
		else if(mesaj == ""){
			$("#gondersonuc").html("<font color=red><b>Mesajı Yazın</b></font>");
		}
		else {
			$("gondersonuc").html("<img src='img/loading.gif' /> Bekleyin");

			jQuery.ajax({
				type : 'POST',
				url : 'inc/hayatipaylas.php',
				data : "mesaj="+mesaj+"&konu="+konu,
				success: function(sonuc){		
					if(sonuc == "ok"){
						$("#gondersonuc").html("<font color=red><b>Mesajınız şuan gönderilemiyor, lütfen sonra tekrar deneyiniz</b></font>");
						
					}
					else {
						$("#gondersonucok").hide();
						$("#gondersonucok").html("<tr><td>"+sonuc+"</td></tr>");
						$("#gondersonucok").show("slow");
					}
				}
			})
							...
							<tr>
								...
								<table border="0" width="100%" id="table14" cellspacing="0" cellpadding="0">
									<tr>
										...
										<table id="gondersonucok" border="0" width="100%" id="table303" cellspacing="0" cellpadding="0">
											<tr>
																	...
																	<tr>
																		...
																		<table border="0" width="100%" id="table321" cellspacing="0" cellpadding="0">
																			<tr>
																				...
																				<td width="10">&nbsp;</td>
																				<td><input type="text" name="baslik" id="baslik" style="font-family: Tahoma; font-size: 8pt" size="60"></td>
																			</tr>
																			<tr>
																			...
																			<tr>
																				...
																				<td width="10">&nbsp;</td>
																				<td><textarea rows="12" name="mesaj" id="mesaj" cols="76" style="font-family: Tahoma; font-size: 8pt; padding-left: 1px; padding-right: 1px"></textarea></td>
																			</tr>
																		</table>
																		</td>
																		<td>&nbsp;</td>
																		...
																		<table border="0" width="100%" id="table313" cellspacing="0" cellpadding="0">
																			<tr>
																					...
																					<tr>
																						...
																						<table border="0" width="100%" id="table320" cellspacing="0" cellpadding="0">
																							...
																							<tr>
																								...
																								<td width="21">&nbsp;</td>
																								<td width="8">&nbsp;</td>
																								<td><p style="padding-left:0px;padding-top:10px;"><span id="gondersonuc"></span></td>
																							</tr>
																						</table>
																						</td>
																				...
																				<table border="0" id="table319" cellspacing="0" cellpadding="0">
																					...
																					<tr>
																						<td width="13"><a href="javascript:gonder()"><img border="0" src="img/bnt_gonder.gif" width="110" height="31"></a></td>
																						<td width="30">&nbsp;</td>
																					</tr>
																				</table>
																						</td>
