...
if($_POST["islem_x"]){
	...
	foreach($mesajid as $ak){
		...
		mysql_query("update from "._MX."uye_mesaj set masaustusil='1' where id='$ak' and gonderilen='$uyeid'");
...
<title>Mesaj Arşiviniz <?=$uyeadi?>, <?=_BASLIK?></title>
							...
							<tr>
								...
								<table border="0" width="100%" id="table14" cellspacing="0" cellpadding="0">
									<tr>
										...
										$result = mysql_query("select count(id) from "._MX."uye_mesaj where gonderilen='$uyeid' and yer='2' and masaustusil='0'");
											...
											<tr>
												...
												<table border="0" width="100%" id="table525" cellspacing="0" cellpadding="0">
													...
													<tr>
														...
														<font color="#800080">
														<b>mesaj arşiviniz boştur</b></font></td>
														<td>&nbsp;</td>
													</tr>
													<tr>
														<td>&nbsp;</td>
										...
										<form action="index.php?sayfa=mesaj_arsiv" method="post" name="mesajform">
										<table border="0" width="100%" id="table201" cellspacing="0" cellpadding="0">
											<tr>
												<td background="img/ust_ac_mor.gif" height="46">
												<table border="0" width="100%" id="table261" cellspacing="0" cellpadding="0">
												...
												<table border="0" width="100%" id="mesajlar" cellspacing="0" cellpadding="0">
													...
													<?
														...
														if($count > 100){
															...
															mysql_query("update from "._MX."uye_mesaj set masaustusil='1' where gonderilen='$uyeid' and yer='2' limit $silinecek");
														...
														$result = mysql_query("select id, gonderen, gonderenad, konu, kayit, durum from "._MX."uye_mesaj where gonderilen='$uyeid' and yer='2' and masaustusil='0' order by oncelik asc, durum desc limit ".(($sayfa-1)*$limit).",".$limit."");
														...
														if($durum == 2) $durum = "<font color=red>okunmamış mesaj</font>";
														else $durum = "okunmuş mesaj";
																...
																<table border="0" width="100%" id="table205" cellspacing="0" cellpadding="0">
																	<tr>
																		...
																		<table border="0" width="100%" id="table206" cellspacing="0" cellpadding="0">
																			<tr>
																				<td>
																				<p class="soru">Gönderen <b><?=$gonderenad?></b></td>
																			</tr>
																			<tr>
																				<td height="4"></td>
																			</tr>
