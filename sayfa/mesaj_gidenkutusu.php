											...
											<tr>
												...
												<table border="0" width="100%" id="table525" cellspacing="0" cellpadding="0">
													...
													<tr>
														...
														<font color="#800080">
														<b>giden kutunuz boştur</b></font></td>
														<td>&nbsp;</td>
													</tr>
													<tr>
														<td>&nbsp;</td>
																...
																<table border="0" width="100%" id="table205" cellspacing="0" cellpadding="0">
																	<tr>
																		...
																		<table border="0" width="100%" id="table206" cellspacing="0" cellpadding="0">
																			<tr>
																				<td>
																				<p class="soru">Gönderilen <b><?=$gonderilenad?></b></td>
																			</tr>
																			<tr>
																				<td height="4"></td>
																			</tr>
																			<tr>
																				<td>
																				<p class="msg_tit"><b><a class="msg_tit" href="index.php?sayfa=mesaj_gidenmesajoku&id=<?=$id?>" title="Mesajı Oku"><?=$konu?></a></b></td>
																			</tr>
																		</table>
																		</td>
																		...
																		<table border="0" width="100%" id="table207" cellspacing="0" cellpadding="0">
																			...
																			<tr>
																				<td align="right">
																				<p class="form_txt"><a class="form_txt" href="index.php?sayfa=mesaj_gidenmesajoku&id=<?=$id?>" title="Mesajı Oku"><font color="#D22A2A">Mesajı Oku</font></a>&nbsp;&nbsp; |&nbsp;&nbsp; <a class="form_txt" href="javascript:void(0)" onclick="pencere('index.php?sayfa=profil&id=<?=$gonderilen?>', '745', '700', 'profilpopup<?=$gonderilen?>', 2, 1, 1);">Profili</a></td>
																			</tr>
																		</table>
																		</td>
																		<td width="15">&nbsp;</td>
