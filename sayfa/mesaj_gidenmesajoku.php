...
<title>Mesaj Oku <?=$uyeadi?>, <?=_BASLIK?></title>
...
<script type="text/javascript">
	...
	function sil(id){
			...
			jQuery.ajax({
				...
				data : "islem=sil2&mesaj="+id,
				success: function(sonuc){		
					window.location = "index.php?sayfa=mesaj_gidenkutusu";
				}
			})
							...
							<tr>
								...
								<table border="0" width="100%" id="table14" cellspacing="0" cellpadding="0">
									<tr>
										...
										<?
										$result = mysql_query("select gonderilen, konu, mesaj, kayit, durum from "._MX."uye_mesaj_giden where id='$mesajid' and gonderen='$uyeid'");
										
										list($gonderilen, $konu, $mesaj, $kayit, $durum) = mysql_fetch_row($result);
																...
																<table border="0" width="100%" id="table291" cellspacing="0" cellpadding="0">
																	<tr>
																		...
																		<table border="0" width="100%" id="table296" cellspacing="0" cellpadding="0">
																			...
																			<tr>
																				<td align="right">
																				<a href="javascript:void(0)" onclick="pencere('index.php?sayfa=profil&id=<?=$gonderilen?>', '745', '700', 'profilpopup<?=$gonderilen?>', 2, 1, 1);"><img border="0" src="img/btn_proflnebak.gif" width="86" height="22"></a></td>
																			</tr>
																		</table>
																				</td>
																				<td width="10">&nbsp;</td>
																			...
																			<tr>
																				...
																				<table border="0" id="table293" cellspacing="0" cellpadding="0">
																					...
																					<tr>
																						<td>&nbsp;</td>
																						<td width="13">&nbsp;</td>
																						<td><a href="javascript:yasakla(<?=$gonderilen?>)"><img border="0" src="img/bnt_msgoku_engelle.gif" width="130" height="31"></a></td>
																						<td width="13">&nbsp;</td>
																						<td><a href="javascript:mesajgonder(<?=$gonderilen?>)"><img border="0" src="img/bnt_msgoku_cevapla.gif" width="110" height="31"></a></td>
																					</tr>
																				</table>
																				</td>
																				<td>&nbsp;</td>
