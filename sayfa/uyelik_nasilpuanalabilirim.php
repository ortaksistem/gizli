...
<title>Nasıl Puan Alabilirim <?=$uyeadi?>, <?=_BASLIK?></title>
														...
														<td width="510">
																<table border="0" style="border-collapse: collapse" width="100%" cellpadding="0">
																	<tr>
																			...
																			<tr>
																				...
																				<table border="0" style="border-collapse: collapse" width="100%" cellpadding="0">
																					<tr>
																						<td width="15">&nbsp;</td>
																						<td height="39">
																						<p class="tit_mesajmer">Puanlarım</td>
																					</tr>
																				</table>
																				</td>
																			</tr>
																					...
																					<tr>
																						...
																						<table border="0" style="border-collapse: collapse" width="100%" cellpadding="0">
																							<tr>
																								...
																								<td height="23">
																								<p class="form_txt">Mesaj Gönderme Puanınız</td>
																					...
																					<tr>
																						...
																						<table border="0" style="border-collapse: collapse" width="100%" cellpadding="0">
																							<tr>
																								<td height="23" width="6">&nbsp;</td>
																								<td height="23">
																								<p class="form_txt">Siteye Login Olma Puanınız</td>
																								<td width="30" align="center">
																		<img border="0" src="img/zdok.gif" width="6" height="5"></td>
																								<td width="55">
																					...
																					<tr>
																						...
																						<table border="0" style="border-collapse: collapse" width="100%" cellpadding="0">
																							<tr>
																								<td height="23" width="6">&nbsp;</td>
																								<td height="23">
																								<p class="form_txt">Ana Resim Puanınız</td>
																								<td width="30" align="center">
																		<img border="0" src="img/zdok.gif" width="6" height="5"></td>
																								<td width="55">
																					...
																					<tr>
																						...
																						<table border="0" style="border-collapse: collapse" width="100%" cellpadding="0">
																							<tr>
																								<td height="23" width="6">&nbsp;</td>
																								<td height="23">
																								<p class="form_txt">Toplam Galeri Puanınız</td>
																								<td width="30" align="center">
																		<img border="0" src="img/zdok.gif" width="6" height="5"></td>
																								<td width="55">
																					...
																					<tr>
																						...
																						<table border="0" style="border-collapse: collapse" width="100%" cellpadding="0">
																							<tr>
																								<td height="23" width="6">&nbsp;</td>
																								<td height="23">
																								<p class="form_txt">Oy Verme Puanınız</td>
																								<td width="30" align="center">
																		<img border="0" src="img/zdok.gif" width="6" height="5"></td>
																								<td width="55">
																					...
																					<tr>
																						...
																						<table border="0" style="border-collapse: collapse" width="100%" cellpadding="0">
																							<tr>
																								<td height="23" width="6">&nbsp;</td>
																								<td height="23">
																								<p class="form_txt">Davet Gönderme Puanınız</td>
																								<td width="30" align="center">
																		<img border="0" src="img/zdok.gif" width="6" height="5"></td>
																								<td width="55">
																								<p class="form_txt">10</td>
																					...
																					<tr>
																						...
																						<table border="0" style="border-collapse: collapse" width="100%" cellpadding="0">
																							<tr>
																								<td height="23" width="6">&nbsp;</td>
																								<td height="23">
																								<p class="form_txt">Gelen Mesaja Cevap Puanınız</td>
																								<td width="30" align="center">
																		<img border="0" src="img/zdok.gif" width="6" height="5"></td>
																								<td width="55">
																								<p class="form_txt">5</td>
																					...
																					<tr>
																						...
																						<table border="0" style="border-collapse: collapse" width="100%" cellpadding="0">
																							<tr>
																								<td height="23" width="6">&nbsp;</td>
																								<td height="23">
																								<p class="form_txt">Hayranlık Puanınız</td>
																								<td width="30" align="center">
																		<img border="0" src="img/zdok.gif" width="6" height="5"></td>
																								<td width="55">
																								<p class="form_txt">5</td>
																					...
																					<tr>
																						...
																						<table border="0" style="border-collapse: collapse" width="100%" cellpadding="0">
																							<tr>
																								<td height="23" width="6">&nbsp;</td>
																								<td height="23">
																								<p class="form_txt">Medium Olma Puanınız</td>
																								<td width="30" align="center">
																		<img border="0" src="img/zdok.gif" width="6" height="5"></td>
																								<td width="55">
																					...
																					<tr>
																						...
																						<table border="0" style="border-collapse: collapse" width="100%" cellpadding="0">
																							<tr>
																								<td height="23" width="6">&nbsp;</td>
																								<td height="23">
																								<p class="form_txt">Large Olma Puanınız</td>
																								<td width="30" align="center">
																		<img border="0" src="img/zdok.gif" width="6" height="5"></td>
																								<td width="55">
																					...
																					<tr>
																						...
																						<table border="0" style="border-collapse: collapse" width="100%" cellpadding="0">
																							<tr>
																								<td height="23" width="6">&nbsp;</td>
																								<td height="23">
																								<p class="form_txt"><b><font color="#F95822">Kullanılabilir Toplam Puan</font></b></td>
																								<td width="30" align="center">
																		<img border="0" src="img/zdok.gif" width="6" height="5"></td>
																								<td width="55">
																		...
																		etmeniz 
																		yeterli 
																		olacaktır. <br>Biriken puanlarınızla üyelik veya SHOP merkezimden 
																		istediğiniz 
																		herhangi 
																		bir 
																		ürünün 
																		...
																		<img border="0" src="img/uyelik_ufak_medium.gif" width="33" height="15"></td>
																				...
																				<p class="cc">ÜYELİK</td>
																							...
																							<tr>
																								<td>
																				<p class="offline"><font color="#0000FF">1 Aylıkta 39,000<br>
																				3 Aylıkta 59,000<br>
																				6 Aylıkta 79,000<br>
																		...
																		<img border="0" src="img/uyelik_ufak_large.gif" width="33" height="15"></td>
																				...
																				<p class="cc">ÜYELİK</td>
																							...
																							<tr>
																								<td>
																				<p class="offline">1 Aylıkta 49,000 <br>
																				3 Aylıkta 69,000 <br>
																				6 Aylıkta 89,000 <br>
