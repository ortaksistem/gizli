...
// PayPal settings
$paypal_email = 'pay@yatakpartnerin.com';
$return_url = "http://www.yatakpartnerin.com/index.php?sayfa=odeme_alindi&item_number=$numaramiz";
$cancel_url = "http://www.yatakpartnerin.com/index.php?sayfa=odeme_alinamadi";
$notify_url = 'http://www.yatakpartnerin.com';
																	...
																	<tr>
																		...
																		<table border="0" style="border-collapse: collapse" width="100%" cellpadding="0">
																			<tr>
																				<td width="15">&nbsp;</td>
																				<td colspan="2">
																					<form id="paypal_form" class="paypal" action="index.php?sayfa=uyelik_yukselt&islemyap=ode" method="post">
