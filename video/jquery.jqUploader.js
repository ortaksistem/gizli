    ...
    jQuery.fn.jqUploader = function(options) {
        return this.each(function(index) {
            ...
            var opts = jQuery.extend({
                ...
                progressMessage: 'Lütfen Bekleyin, Yükleniyor ',
                endMessage:    'Ýptal edildi'
            }, options || {}
            );
            ...
            TerminateJQUploader = function(containerId,filename,varname){
                ...
                $this.text('').append('<span style="color:#00CC00">Dosya baþarýyla yüklendi. Video Editörlerimiz tarafýndan incelendikten sonra yayýna girecektir. Teþekkür ederiz.</span><input name="'+varname+'" type="hidden" id="'+varname+'" value="'+filename+'"/>');
